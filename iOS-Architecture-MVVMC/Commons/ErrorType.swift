...
//
//  Created by NALS_MACBOOK_207 on 06/06/2022.
//

import Foundation

enum LocalErrorType: Error {
    case `default`
...
enum ServiceErrorType: Error {
    ...
    case encodeData
    case localized
    case paramInputNotwork
    case noInternet
    case statusCode(Int)
    case custom(String) // using if need
    case refreshToken
    case serverDefined
    ...
    var message: String {
        switch self {
        case .timeOut:
            return Strings.Common.serviceTimeOutMessage
        case .urlNotwork:
            return Strings.Common.serviceUrlMessage
        case .json:
            return Strings.Common.serviceJsonMessage
        case .localized:
            return Strings.Common.serviceLocalizedMessage
        case .noInternet:
            return Strings.Common.serviceNointernetMessage
        case .statusCode:
            return Strings.Common.serviceStatuscodeMessage
        case let .custom(string):
            return Strings.Common.serviceCustomMessage + string
        case .noData:
            return Strings.Common.serviceNoDataMessage
        case .jsonKeyMapping:
            return Strings.Common.serviceMapFromJsonKeyMessage
        case .encodeData:
            return Strings.Common.serviceEncodeDataFailMessage
        case .paramInputNotwork:
            return Strings.Common.serviceParamInputNotworkMessage
        case .refreshToken:
            return Strings.Common.serviceRefreshTokenFailedMessage
        default:
            return Strings.Common.serviceAnyMessage
        }
    }
}

enum StatusCodeErrorCommon {
    case informational
    case success
    case redirection
    case clientError
    case serverError
    case `default` // 0 ... 100 or >= 600
    ...
    var description: String {
        ...
        case .serverError:
            return "serverError"
        case .default:
            return "Any Error out define"
        }
    }

    static func typeError(_ statusCode: Int) -> Self {
        switch statusCode {
        case 100 ... 199:
            return .informational
        case 200 ... 299:
...
enum HTTPStatuscode: Int, CustomStringConvertible {
    ...
    var description: String {
        ...
        default:
            return "Out Of Define Status Code"
        }
    }
}
